        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_MaximumQuantity_Positive", "[MaximumQuantity] IS NULL OR [MaximumQuantity] >= [MinimumQuantity]");
                    table.CheckConstraint("CK_Products_MinimumQuantity_Positive", "[MinimumQuantity] >= 1");
                    table.CheckConstraint("CK_Products_PreparationTime_NonNegative", "[PreparationTimeInDays] >= 0");
                    table.ForeignKey(
